...
mathjax: yes
output: pdf_document
summary: Illustrates the effects of optimizing code in R versus C++ across both serial
  and parallel conditions with 3D arrays.
...
Source: https://github.com/RcppCore/rcpp-gallery/blob/gh-pages/src/2016-06-08-optimizing-code-vs-recognizing-patterns-with-3d-arrays.Rmd
